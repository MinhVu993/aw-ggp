...
export const TRANSLATIONS: Translations = {
  ...
  status_returned_appr: { vi: 'Bị trả về', en: 'Returned', zh: '被退回' },
  status_completed_appr: { vi: 'Hoàn tất', en: 'Completed', zh: '已完成' },
  approver: { vi: 'Người duyệt', en: 'Approver', zh: '审批人' },
  reject_reason: { vi: 'Lý do từ chối', en: 'Reject Reason', zh: '拒绝原因' },
  return_reason: { vi: 'Lý do trả về', en: 'Return Reason', zh: '退回原因' },
  btn_approve: { vi: 'Phê duyệt', en: 'Approve', zh: '批准' },
  btn_reject: { vi: 'Từ chối', en: 'Reject', zh: '拒绝' },
  btn_return: { vi: 'Trả về', en: 'Return', zh: '退回' },
  btn_resubmit: { vi: 'Sửa & Nộp lại', en: 'Edit & Resubmit', zh: '修改并重新提交' },
  please_enter_return_reason: { vi: 'Vui lòng điền lý do trả về đơn:', en: 'Please enter the reason for returning the request:', zh: '请输入退回申请的原因：' },
  request_return_success: { vi: 'Đã trả về đơn yêu cầu!', en: 'Request returned successfully!', zh: '申请已成功退回！' },
  request_resubmit_success: { vi: 'Đã cập nhật và nộp lại đơn thành công!', en: 'Request updated and resubmitted successfully!', zh: '申请已成功更新并重新提交！' },
  ...
  history_status: { vi: 'Trạng thái', en: 'Status', zh: '状态' },
  history_empno: { vi: 'Mã NV', en: 'Emp No', zh: '工号' },
  history_approver: { vi: 'Người duyệt', en: 'Approver', zh: '审批人' },
  ...
  status_todo_appr: { vi: 'Cần duyệt', en: 'To Do', zh: '待办' },
  ...
  guard_title: { vi: 'Cổng Bảo Vệ - Kiểm soát mang hàng ra cổng', en: 'Security Gate - Goods Gate Pass', zh: '安全门 - 货物出门凭条' },
